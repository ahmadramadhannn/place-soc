...
const appCss = "/assets/app--5LtTLBX.css";
const seo = ({
  title,
  description,
  keywords,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2 flex gap-2 text-lg", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/playground", activeProps: {
          className: "font-bold"
        }, children: "Playground" })
      ] }),
...
const $$splitComponentImporter$5 = () => import("./users-BxSofYak.js");
...
const Route$8 = createFileRoute("/redirect")({
  beforeLoad: () => {
    throw redirect({
      to: "/posts"
    });
...
const $$splitComponentImporter$4 = () => import("./playground-ThXKII6X.js");
const Route$7 = createFileRoute("/playground")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./lab-D58uIsDk.js");
const Route$6 = createFileRoute("/lab")({
...
const $$splitComponentImporter$2 = () => import("./deferred-CkpL0Y1x.js");
const personServerFn = createServerFn({
  method: "GET"
}).inputValidator((d) => d).handler(createSsrRpc("f76e8f8721c12c8547a3ced6a10916f5b5076c1a10dcbeaa607360ce419d0a48"));
const slowServerFn = createServerFn({
  method: "GET"
}).inputValidator((d) => d).handler(createSsrRpc("fc3988c64f434639dfd4eab3f926b87ee39cc0c14f65b4d0e852c7fd73279a3b"));
const Route$5 = createFileRoute("/deferred")({
  loader: async () => {
    return {
...
const Route$4 = createFileRoute("/customScript.js")({
  server: {
    handlers: {
      GET: () => {
...
const $$splitComponentImporter$1 = () => import("./about-CwArHHLA.js");
const Route$3 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-WcqZA0eQ.js");
...
const testMiddleware = createMiddleware().middleware([testParentMiddleware]).server(async ({ next }) => {
...
const Route2 = createFileRoute("/api/users/$userId")({
  server: {
    handlers: {
...
const UsersRoute = Route$9.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => Route$a
});
const RedirectRoute = Route$8.update({
  id: "/redirect",
  path: "/redirect",
  getParentRoute: () => Route$a
});
const PlaygroundRoute = Route$7.update({
  id: "/playground",
  path: "/playground",
  getParentRoute: () => Route$a
});
const LabRoute = Route$6.update({
  id: "/lab",
  path: "/lab",
  getParentRoute: () => Route$a
});
const DeferredRoute = Route$5.update({
  id: "/deferred",
  path: "/deferred",
  getParentRoute: () => Route$a
});
const CustomScriptDotjsRoute = Route$4.update({
  id: "/customScript.js",
...
const ApiUsersUserIdRoute = Route2.update({
  id: "/$userId",
  path: "/$userId",
