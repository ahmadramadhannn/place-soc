...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CmLUbJH-.js");
...
const manifest = { "f76e8f8721c12c8547a3ced6a10916f5b5076c1a10dcbeaa607360ce419d0a48": {
  ...
  importer: () => import("./deferred-Cv00T3CQ.js")
...
async function getEntries() {
  if (cachedRouterEntry === null) {
    cachedRouterEntry = await import("./router-CvQXpfce.js").then((n) => n.r);
  }
...
export {
  ...
  createServerFn as v,
  warning as w,
  getRequestHeaders as x,
  createServerRpc as y,
  defaultSerializeError as z
};
